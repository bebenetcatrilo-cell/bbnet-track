...
// Sección "Familias" (Track Familia) — EN CONSTRUCCIÓN
...
export default function Pagina() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', textAlign: 'center', padding: '20px' }}>
      ...
      <h1 style={{ fontSize: '24px', fontWeight: 700, marginBottom: '8px' }}>Familias</h1>
      <p style={{ color: 'var(--texto-suave)', fontSize: '15px', maxWidth: '440px', lineHeight: 1.5 }}>
        Acá vas a dar de alta y gestionar las familias que contratan el rastreo de sus hijos.
      </p>
